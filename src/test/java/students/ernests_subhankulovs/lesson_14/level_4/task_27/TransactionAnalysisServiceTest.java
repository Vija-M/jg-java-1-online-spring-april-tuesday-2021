package students.ernests_subhankulovs.lesson_14.level_4.task_27;
...
class TransactionAnalysisServiceTest {
    ...
    @Test
    void testFindDistinctTransactionTradersSize() {
        Trader brian = new Trader("Brian","Cambridge");
        Trader raoul = new Trader("Raoul", "Cambridge");
        Trader mario = new Trader("Mario","Milan");
        Trader alan = new Trader("Alan","Cambridge");
        ...
        TransactionAnalysisService service = new TransactionAnalysisService();
        TransactionTestData testData = new TransactionTestData();
        Assertions.assertEquals(traders.size(), service.findDistinctTransactionTraders(testData.getTransactions()).size());
    }

    @Test
    void testFindDistinctTransactionTraders() {
        Trader brian = new Trader("Brian","Cambridge");
        Trader raoul = new Trader("Raoul", "Cambridge");
        Trader mario = new Trader("Mario","Milan");
        Trader alan = new Trader("Alan","Cambridge");
        List<Trader> traders = Arrays.asList(brian, raoul, mario, alan);
        TransactionAnalysisService service = new TransactionAnalysisService();
        TransactionTestData testData = new TransactionTestData();
        for (int i = 0; i < traders.size(); i++) {
            Assertions.assertEquals(traders.get(0).getName(), service.findDistinctTransactionTraders(testData.getTransactions()).get(0).getName());
        }
    }
}