...
class FruitStorageTest {
    ...
    void testFindApplesByWeightOver150AndGreenColor() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(200, fruitStorage.findApples(fruitStorage.getAllApples(), new AppleGreenAndHeavyWeightPredicate()).get(0).getWeight());
    }

    @Test
    void testFindApplesByGreenColorAndWeightOver150() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals("green", fruitStorage.findApples(fruitStorage.getAllApples(), new AppleGreenAndHeavyWeightPredicate()).get(0).getColor());
    }
    ...
    void testGetAllRedApples3rdColorWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals("red", fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> "red".equals(apple.getColor())).get(2).getColor());
    }

    @Test
    void testGetAllRedApples3rdWeightWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(200, fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> "red".equals(apple.getColor())).get(2).getWeight());
    }

    @Test
    void testGetAllGreenApplesSizeWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(3, fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> "green".equals(apple.getColor())).size());
    }

    @Test
    void testGetAllGreenApples1stColorWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals("green", fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> "green".equals(apple.getColor())).get(0).getColor());
    }

    @Test
    void testGetAllGreenApples1stWeightWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(200, fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> "green".equals(apple.getColor())).get(0).getWeight());
    }

    @Test
    void testGetAllGreenApples2ndColorWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals("green", fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> "green".equals(apple.getColor())).get(1).getColor());
    }

    @Test
    void testGetAllGreenApples2ndWeightWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(90, fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> "green".equals(apple.getColor())).get(1).getWeight());
    }

    @Test
    void testGetAllGreenApples3rdColorWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals("green", fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> "green".equals(apple.getColor())).get(2).getColor());
    }

    @Test
    void testGetAllGreenApples3rdWeightWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(50, fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> "green".equals(apple.getColor())).get(2).getWeight());
    }
    ...
    void testFindApplesByWeightOver150WithAnonymousClass() {
        ...
        apples.add(new Apple("yellow", 170));
        for (int i = 0; i < apples.size(); i++) {
            Assertions.assertEquals(apples.get(i).getWeight(), fruitStorage.findApples(fruitStorage.getAllApples(), (Apple apple) -> apple.getWeight() > 150).get(i).getWeight());
        }
    }
