...
class FruitStorageTest {
    ...
    void testGetAllRedApplesSizeWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(3, fruitStorage.findApples(fruitStorage.getAllApples(), new ApplePredicate() {
    ...
    void testGetAllRedApples1stColorWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals("red", fruitStorage.findApples(fruitStorage.getAllApples(), new ApplePredicate() {
            public boolean test(Apple apple) {
                return "red".equals(apple.getColor());
            }
        }).get(0).getColor());
    ...
    void testGetAllRedApples1stWeightWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(100, fruitStorage.findApples(fruitStorage.getAllApples(), new ApplePredicate() {
            public boolean test(Apple apple) {
                return "red".equals(apple.getColor());
            }
        }).get(0).getWeight());
    ...
    void testGetAllRedApples2ndWeightWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(160, fruitStorage.findApples(fruitStorage.getAllApples(), new ApplePredicate() {
            public boolean test(Apple apple) {
                return "red".equals(apple.getColor());
            }
        }).get(1).getWeight());
    ...
    void testGetAllRedApples3rdWeightWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(200, fruitStorage.findApples(fruitStorage.getAllApples(), new ApplePredicate() {
            public boolean test(Apple apple) {
                return "red".equals(apple.getColor());
            }
        }).get(2).getWeight());
    ...
    void testGetAllGreenApples1stColorWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals("green", fruitStorage.findApples(fruitStorage.getAllApples(), new ApplePredicate() {
            public boolean test(Apple apple) {
                return "green".equals(apple.getColor());
            }
        }).get(0).getColor());
    ...
    void testGetAllGreenApples2ndWeightWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(90, fruitStorage.findApples(fruitStorage.getAllApples(), new ApplePredicate() {
            public boolean test(Apple apple) {
                return "green".equals(apple.getColor());
            }
        }).get(1).getWeight());
    ...
    void testGetAllGreenApples3rdWeightWithAnonymousClass() {
        FruitStorage fruitStorage = new FruitStorage();
        Assertions.assertEquals(50, fruitStorage.findApples(fruitStorage.getAllApples(), new ApplePredicate() {
            public boolean test(Apple apple) {
                return "green".equals(apple.getColor());
            }
        }).get(2).getWeight());
    ...
    void testFindApplesByWeightOver150WithAnonymousClass() {
        ...
        apples.add(new Apple("yellow", 170));
        for (int i = 0; i < apples.size(); i++) {
            Assertions.assertEquals(apples.get(i).getWeight(), fruitStorage.findApples(fruitStorage.getAllApples(), new ApplePredicate() {
                public boolean test(Apple apple) {
