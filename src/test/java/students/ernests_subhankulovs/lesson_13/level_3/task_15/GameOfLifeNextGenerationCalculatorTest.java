package students.ernests_subhankulovs.lesson_13.level_3.task_15;
...
class GameOfLifeNextGenerationCalculatorTest {
    ...
    void cell1x2dies() {
        GameOfLifeNextGenerationCalculator calculator = new GameOfLifeNextGenerationCalculator();
        assertFalse(calculator.calculate(grid)[0][1]);
    }
    ...
    void cell2x2dies() {
        GameOfLifeNextGenerationCalculator calculator = new GameOfLifeNextGenerationCalculator();
        assertFalse(calculator.calculate(grid)[1][1]);
    }

    @Test
    void cell2x3lives() {
        GameOfLifeNextGenerationCalculator calculator = new GameOfLifeNextGenerationCalculator();
        assertFalse(calculator.calculate(grid)[1][2]);
    }
