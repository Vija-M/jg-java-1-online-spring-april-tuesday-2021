...
class DayOfTheWeekDetectorTest {
    ...
    public void shouldReturnMonday() {
        ...
        checkTestResult("Monday"==dayOfTheWeek, "Monday");
    }

    public void shouldReturnTuesday() {
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeek(2);
        checkTestResult("Tuesday"==dayOfTheWeek, "Tuesday");
    }

    public void shouldReturnWednesday() {
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeek(3);
        checkTestResult("Wednesday"==dayOfTheWeek, "Wednesday");
    }
    ...
    public void shouldReturnFriday() {
        ...
        checkTestResult("Friday"==dayOfTheWeek, "Friday");
    }

    public void shouldReturnSaturday() {
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeek(6);
        checkTestResult("Saturday"==dayOfTheWeek, "Saturday");
    }

    public void shouldReturnSunday() {
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeek(7);
        checkTestResult("Sunday"==dayOfTheWeek, "Sunday");
    }

    public void shouldReturnDefault() {
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
//как произвольный пример снизу
        checkTestResult("Not correct day number"==detector.findDayOfTheWeek(8), "Not correct day number");
    }
