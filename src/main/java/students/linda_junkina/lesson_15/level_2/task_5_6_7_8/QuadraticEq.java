...
class QuadraticEq {
    ...
    public String discriminantGreaterThan0(double a, double b, double discriminant) {
        double x1 = (-b - Math.sqrt(discriminant)) / (2 * a);
        double x2 = (-b + Math.sqrt(discriminant)) / (2 * a);
        return "x1 = " + x1 + ", x2 = " + x2;
    }

    public String discriminantEquals0(double a, double b) {
        double x = -b / (2 * a);
        return "x = " + x;
    }

    public String discriminantLessThan0() {
