package students.dmitriy_shukailo.lesson_11.level_1.task_5;
...
class BookListContainsDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("containsBook: " + containsBook);// должно быть true

        Book bookNotInTheList = new Book("A3", "B3");
        boolean notContainsBook = books.contains(bookNotInTheList);
        System.out.println("notContainsBook: " + notContainsBook);// должно быть false
    }
