package students.ernests_subhankulovs.lesson_11.level_6.task_31;
...
class InMemoryBookRepositoryTest {
    ...
    public void testGetEachAuthorBookCount() {
        ...
        bookRepository.save(new Book("A2", "B3"));
        bookRepository.save(new Book("A2", "B4"));
        Map<String, Integer> eachAuthorRealBookCount = bookRepository.getEachAuthorBookCount();
        Map<String, Integer> eachAuthorExpectedBookCount = new HashMap<>();
        eachAuthorExpectedBookCount.put("A1", 2);
        eachAuthorExpectedBookCount.put("A2", 3);
        assertions.assertMapCountTestResult(eachAuthorRealBookCount, eachAuthorExpectedBookCount, "Books are correctly counted by author");
    }
}
