...
class InMemoryBookRepositoryTest {
    ...
    public void testYearOfIssueSearchCriteria() {
        ...
        assertTestResult(true, realResult, "Year of issue search criteria returns true");
    }

    public void testYearOfIssueSearchCriteriaNegative() {
        YearOfIssueSearchCriteria yearOfIssueSearchCriteria = new YearOfIssueSearchCriteria("1999");
        boolean realResult = yearOfIssueSearchCriteria.match(new Book("A1", "B1", "2000"));
        assertTestResult(false, realResult, "Year of issue search criteria returns false");
    }
    ...
    public void testAndSearchCriteria() {
        ...
        assertTestResult(true, realResult, "Author and title search criteria returns true");
        realResult = andSearchCriteriaAuthorYear.match(new Book("A1", "B1", "1999"));
        assertTestResult(true, realResult, "Author and year search criteria returns true");
        realResult = andSearchCriteriaTitleAuthor.match(new Book("A1", "B1", "1999"));
        assertTestResult(true, realResult, "Title and author search criteria returns true");
        realResult = andSearchCriteriaTitleYear.match(new Book("A1", "B1", "1999"));
        assertTestResult(true, realResult, "Title and year search criteria returns true");
        realResult = andSearchCriteriaYearAuthor.match(new Book("A1", "B1", "1999"));
        assertTestResult(true, realResult, "Year and author search criteria returns true");
        realResult = andSearchCriteriaYearTitle.match(new Book("A1", "B1", "1999"));
        assertTestResult(true, realResult, "Year and title search criteria returns true");
    }
    ...
    public void testAndSearchCriteriaNegative() {
        ...
        assertTestResult(false, realResult, "Author and title search criteria returns false (wrong author and title)");
        realResult = andSearchCriteriaAuthorTitle.match(new Book("A2", "B1", "1999"));
        assertTestResult(false, realResult, "Author and title search criteria returns false (wrong author)");
        realResult = andSearchCriteriaAuthorTitle.match(new Book("A1", "B2", "1999"));
        assertTestResult(false, realResult, "Author and title search criteria returns false (wrong title)");

        realResult = andSearchCriteriaAuthorYear.match(new Book("A2", "B1", "2000"));
        assertTestResult(false, realResult, "Author and year search criteria returns false (wrong author and year)");
        realResult = andSearchCriteriaAuthorYear.match(new Book("A2", "B1", "1999"));
        assertTestResult(false, realResult, "Author and year search criteria returns false (wrong author)");
        realResult = andSearchCriteriaAuthorYear.match(new Book("A1", "B1", "2000"));
        assertTestResult(false, realResult, "Author and year search criteria returns false (wrong year)");

        realResult = andSearchCriteriaTitleAuthor.match(new Book("A2", "B2", "1999"));
        assertTestResult(false, realResult, "Title and author search criteria returns false (wrong title and author)");
        realResult = andSearchCriteriaTitleAuthor.match(new Book("A2", "B1", "1999"));
        assertTestResult(false, realResult, "Title and author search criteria returns false (wrong author)");
        realResult = andSearchCriteriaTitleAuthor.match(new Book("A1", "B2", "1999"));
        assertTestResult(false, realResult, "Title and author search criteria returns false (wrong title)");

        realResult = andSearchCriteriaTitleYear.match(new Book("A1", "B2", "2000"));
        assertTestResult(false, realResult, "Title and year search criteria returns false (wrong title and year)");
        realResult = andSearchCriteriaTitleYear.match(new Book("A1", "B2", "1999"));
        assertTestResult(false, realResult, "Title and year search criteria returns false (wrong title)");
        realResult = andSearchCriteriaTitleYear.match(new Book("A1", "B1", "2000"));
        assertTestResult(false, realResult, "Title and year search criteria returns false (wrong year)");

        realResult = andSearchCriteriaYearAuthor.match(new Book("A2", "B1", "2000"));
        assertTestResult(false, realResult, "Year and author search criteria returns false (wrong year and author)");
        realResult = andSearchCriteriaYearAuthor.match(new Book("A2", "B1", "1999"));
        assertTestResult(false, realResult, "Year and author search criteria returns false (wrong author)");
        realResult = andSearchCriteriaYearAuthor.match(new Book("A1", "B1", "2000"));
        assertTestResult(false, realResult, "Year and author search criteria returns false (wrong year)");

        realResult = andSearchCriteriaYearTitle.match(new Book("A1", "B2", "2000"));
        assertTestResult(false, realResult, "Year and title search criteria returns false (wrong year and title)");
        realResult = andSearchCriteriaYearTitle.match(new Book("A1", "B2", "1999"));
        assertTestResult(false, realResult, "Year and title search criteria returns false (wrong title)");
        realResult = andSearchCriteriaYearTitle.match(new Book("A1", "B1", "2000"));
        assertTestResult(false, realResult, "Year and title search criteria returns false (wrong year)");
    }
