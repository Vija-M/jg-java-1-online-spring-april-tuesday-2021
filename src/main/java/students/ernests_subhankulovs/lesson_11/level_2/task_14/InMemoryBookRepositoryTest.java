...
class InMemoryBookRepositoryTest {
    ...
    private void assertBookTestResult(List<students.ernests_subhankulovs.lesson_11.level_2.task_14.Book> expectedResult, List<Book> realResult, String testName) {
