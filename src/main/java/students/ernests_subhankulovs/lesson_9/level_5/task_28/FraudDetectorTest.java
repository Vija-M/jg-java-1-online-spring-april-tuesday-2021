...
class FraudDetectorTest {
    ...
    public void fifthRulePassTest() {
        ...
        Transaction transaction = new Transaction(trader, 1000);
        FraudRule5 fraudRule5 = new FraudRule5("Rule 5");
        assertTestResult(false, fraudRule5.isFraud(transaction), "5th rule pass test");
    }
    ...
    public void fifthRuleFailTest() {
        ...
        FraudRule5 fraudRule5 = new FraudRule5("Rule 5");
        assertTestResult(true, fraudRule5.isFraud(transaction), "5th rule fail test");
    }
