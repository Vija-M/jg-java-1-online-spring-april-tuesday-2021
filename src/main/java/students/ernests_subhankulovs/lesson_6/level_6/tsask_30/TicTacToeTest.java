...
class TicTacToeTest {
    ...
    void testWinnerFirstLineFirstPlayer() {
        int[][] field = {{0, 0, 0}, {-1, 0, -1}, {0, -1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 0), "Test if 1st player wins - 1st horizontal line");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - 1st horizontal line");
    }

    void testWinnerFirstLineSecondPlayer() {
        int[][] field = {{1, 1, 1}, {-1, 0, -1}, {0, -1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 1), "Test if 2nd player wins - 1st horizontal line");
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - 1st horizontal line");
    }

    void testWinnerSecondLineFirstPlayer() {
        int[][] field = {{-1, 0, -1}, {0, 0, 0}, {0, -1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 0), "Test if 1st player wins - 2nd horizontal line");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - 2nd horizontal line");

    }

    void testWinnerSecondLineSecondPlayer() {
        int[][] field = { {-1, 0, -1}, {1, 1, 1}, {0, -1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 1), "Test if 2nd player wins - 2nd horizontal line");
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - 2nd horizontal line");
    }

    void testWinnerThirdLineFirstPlayer() {
        int[][] field = { {-1, 0, -1}, {0, -1, 0}, {0, 0, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 0), "Test if 1st player wins - 3rd horizontal line");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - 3rd horizontal line");

    }

    void testWinnerThirdLineSecondPlayer() {
        int[][] field = { {-1, 0, -1}, {0, -1, 0}, {1, 1, 1}};
        assertTestResult(true, ticTacToe.isWin(field, 1), "Test if 2nd player wins - 3rdt horizontal line");
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - 3rd horizontal line");
    }

    void testWinnerFirstColumnFirstPlayer() {
        int[][] field = {{0, -1, 0}, {0, 0, -1}, {0, -1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 0), "Test if 1st player wins - 1st vertical column");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - 1st vertical column");
    }

    void testWinnerFirstColumnSecondPlayer() {
        int[][] field = {{1, -1, 0}, {1, 0, -1}, {1, -1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 1), "Test if 2nd player wins - 1st vertical column");
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - 1st vertical column");
    }

    void testWinnerSecondColumnFirstPlayer() {
        int[][] field = {{-1, 0, 0}, {-1, 0, -1}, {0, 0, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 0), "Test if 1st player wins - 2nd vertical column");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - 2nd vertical column");
    }

    void testWinnerSecondColumnSecondPlayer() {
        int[][] field = {{-1, 1, 0}, {0, 1, -1}, {-1, 1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 1), "Test if 2nd player wins - 2nd vertical column");
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - 2nd vertical column");
    }

    void testWinnerThirdColumnFirstPlayer() {
        int[][] field = {{-1, 0, 0}, {-1, 1, 0}, {0, -1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 0), "Test if 1st player wins - 3rd vertical column");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - 3rd vertical column");
    }

    void testWinnerThirdColumnSecondPlayer() {
        int[][] field = {{-1, 0, 1}, {0, -1, 1}, {-1, 1, 1}};
        assertTestResult(true, ticTacToe.isWin(field, 1), "Test if 2nd player wins - 3rd vertical column");
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - 3rd vertical column");
    }

    void testWinnerFirstDiagonalFirstPlayer() {
        int[][] field = {{0, 1, -1}, {-1, 0, 1}, {1, -1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 0), "Test if 1st player wins - 1st diagonal");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - 1st diagonal");
    }

    void testWinnerFirstDiagonalSecondPlayer() {
        int[][] field = {{1, 0, -1}, {0, 1, 0}, {-1, 1, 1}};
        assertTestResult(true, ticTacToe.isWin(field, 1), "Test if 2nd player wins - 1st diagonal");
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - 1st diagonal");
    }

    void testWinnerSecondDiagonalFirstPlayer() {
        int[][] field = {{0, 1, 0}, {-1, 0, 1}, {0, -1, 0}};
        assertTestResult(true, ticTacToe.isWin(field, 0), "Test if 1st player wins - 2nd diagonal");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - 2n diagonal");
    }

    void testWinnerSecondDiagonalSecondPlayer() {
        int[][] field = {{1, 0, 1}, {0, 1, 0}, {1, 1, 1}};
        assertTestResult(true, ticTacToe.isWin(field, 1), "Test if 2nd player wins - 2nd diagonal");
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - 2nd diagonal");
    }

    void testWinnerNoWinnerHorizontally() {
        int[][] field = { {1, 0, 1}, {0, -1, 0}, {1, 0, 1}};
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - no winning horizontal lines");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - no winning horizontal lines");
    }

    void testWinnerNoWinnerVertically() {
        int[][] field = {{1, 0, 1}, {0, -1, 0}, {1, 0, 1}};
        assertTestResult(false, ticTacToe.isWin(field, 0), "Test if 1st player doesn't win - no winning vertical column");
        assertTestResult(false, ticTacToe.isWin(field, 1), "Test if 2nd player doesn't win - no winning vertical column");
    }

    void testDrawPosition() {
        int[][] field = {{1, 0, 1}, {1, 0, 0}, {0, 1, 1}};
        assertTestResult(true, ticTacToe.isDraw(field), "Test draw position");
    }

    void testNonDrawPosition() {
        int[][] field = {{-1, 0, 1}, {1, 1, 0}, {0, 0, 1}};
        assertTestResult(false, ticTacToe.isDraw(field), "Test an unfinished game - not a draw position");
    }

    void testWinPositionForDraw() {
        int[][] field = {{1, 0, 1}, {1, 1, 0}, {0, 0, 1}};
        assertTestResult(false, ticTacToe.isDraw(field), "Test a win scenario - not a draw position");
    }
