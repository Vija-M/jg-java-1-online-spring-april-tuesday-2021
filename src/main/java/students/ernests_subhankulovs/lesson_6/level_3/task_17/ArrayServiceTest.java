...
class ArrayServiceTest {
    ...
    public void checkArraySort() {
        int[] arrayToTest = {4, 5, 1, 3, 2};
        int[] expectedArray = {1, 2, 3, 4, 5};
        arrayService.sort(arrayToTest);
        checkArrays(arrayToTest, expectedArray, "Test array sort");
    }

    public void checkRevertedArraySort() {
        int[] arrayToTest = {5, 4, 3, 2, 1};
        int[] expectedArray = {1, 2, 3, 4, 5};
        arrayService.sort(arrayToTest);
        checkArrays(arrayToTest, expectedArray, "Test reverted array sort");
    }

    public void checkSortedArraySort() {
        int[] arrayToTest = {1, 2, 3, 4, 5};
        int[] expectedArray = {1, 2, 3, 4, 5};
        arrayService.sort(arrayToTest);
        checkArrays(arrayToTest, expectedArray, "Test already sorted array sort");
    }
