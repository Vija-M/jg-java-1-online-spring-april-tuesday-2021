package students.vija_m.lesson_6.level_6.task_29;
...
class TicTacToeTest {
    ...
    void drawPositionTestGameNotFinished() {
        int[][] field = {{0, -1, 1}, {1, 1, 0}, {0, 0, 1}};
        assertTest(false, ticTacToe.isDrawPosition(field), "Draw position test - game isn't over");
    }

    void drawPositionTestWinnerScenario() {
        int[][] field = {{1, 1, 1}, {1, 1, 0}, {0, 0, 1}};
        assertTest(false, ticTacToe.isDrawPosition(field), "Draw position test - there is a winner");
    }

    void fieldCreationTest() {
        int[][] field = {{-1, -1, -1}, {-1, -1, -1}, {-1, -1, -1}};
        assertCreationTest(field, ticTacToe.createField(), "TicTacToe field creation.");
    }
    ...
    private void assertCreationTest(int[][] expected, int[][] real, String testName) {
