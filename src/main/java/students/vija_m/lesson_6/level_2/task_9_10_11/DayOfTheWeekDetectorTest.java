...
class DayOfTheWeekDetectorTest {
    ...
    public static void main(String[] args) {
        ...
        test.shouldReturnNotCorrect1();
        test.shouldReturnNotCorrect2();
    }
    ...
    public void shouldReturnNotCorrect1() {
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeek(-1);
        checkTestResult("Not correct day number".equals(dayOfTheWeek), "Wrong info test 1");
    }

    public void shouldReturnNotCorrect2() {
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeek(198);
        checkTestResult("Not correct day number".equals(dayOfTheWeek), "Wrong info test 2");
    }
