...
class BookRepositoryTest {
    public static void main(String[] args) {
        ...
        test.deleteBooksByTitle();
        test.notDeleteBooksByTitle();
    }
    ...
    public void deleteBooksByAuthor() {
        ...
        bookRep.deleteByAuthor("AUTHOR3");
        List<Book> bookMustBeFound = new ArrayList<>();
        bookMustBeFound.add(new Book("AUTHOR1", "TITLE1"));
        bookMustBeFound.add(new Book("AUTHOR1", "TITLE2"));
        bookMustBeFound.add(new Book("AUTHOR2", "TITLE3"));
        bookMustBeFound.add(new Book("AUTHOR1", "TITLE5"));
    ...
    public void deleteBooksByTitle() {
        ...
        bookRep.save(new Book("AUTHOR2", "TITLE1"));
        bookRep.save(new Book("AUTHOR3", "TITLE3"));
        bookRep.save(new Book("AUTHOR4", "TITLE1"));
        bookRep.save(new Book("AUTHOR5", "TITLE5"));
        bookRep.deleteByTitle("TITLE1");
        List<Book> bookMustBeFound = new ArrayList<>();
        bookMustBeFound.add(new Book("AUTHOR3", "TITLE3"));
        bookMustBeFound.add(new Book("AUTHOR5", "TITLE5"));
        assertBookListTestResult(bookRep.getBookList(), bookMustBeFound, "Books was removed by title");
    }

    public void notDeleteBooksByTitle() {
        InMemoryBookRepository bookRep = new InMemoryBookRepository();
        bookRep.save(new Book("AUTHOR1", "TITLE1"));
        bookRep.save(new Book("AUTHOR2", "TITLE2"));
        bookRep.save(new Book("AUTHOR3", "TITLE3"));
        bookRep.deleteByTitle("TITLE4");
        List<Book> bookMustBeFound = new ArrayList<>();
        bookMustBeFound.add(new Book("AUTHOR1", "TITLE1"));
        bookMustBeFound.add(new Book("AUTHOR2", "TITLE2"));
        bookMustBeFound.add(new Book("AUTHOR3", "TITLE3"));
        assertBookListTestResult(bookRep.getBookList(), bookMustBeFound, "Books was`t removed by title");
    }
